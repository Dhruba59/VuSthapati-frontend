...
import {
  NewsCardSkeleton,
} from "@/components/skeleton/news-card-skeleton";
    ...
    return (
      <section className="px-4 sm:px-0 container mx-auto">
        <div className="mx-auto space-y-2">
          <h2 className="text-header font-extrabold my-3 text-black/60">
            News
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {news.map((news) => (
              <div
                ...
                className="bg-white shadow-lg overflow-hidden h-[330px] cursor-pointer"
              >
                <Image
                ...
                <div className="p-4">
                  ...
                  <h3 className="font-sans text-xl font-semibold truncate text-black/75">
                    {news.title}
                  </h3>
                </div>
              </div>
