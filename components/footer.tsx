...
const Footer = async () => {
    ...
    return (
        <footer className="w-full border-t py-6 md:py-4 px-4 md:px-16 lg:px-20">
            ...
            <div className='flex flex-col justify-center text-center md:text-start md:flex-row gap-2 items-center'>
                ...
                <div className="mt-4 text-xs">
                    ...
                    <p>Address: {contactInfo?.address?.street + ', ' + contactInfo?.address?.city}<br></br>{contactInfo?.address?.country}</p>
                    {/* <p>Phone: +1 (123) 456-7890</p> */}
                    {/* <p>Email: <a href="mailto:yourname@example.com" className="text-blue-400 hover:underline">yourname@example.com</a></p> */}
                </div>
                <div className="flex gap-4 -ml-2 justify-center md:justify-start">
